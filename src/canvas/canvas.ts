...
export interface Canvas {
  displayGroup: Selection<SVGSVGElement, unknown, HTMLElement, any>
  config: CanvasConfigStrict
}

export function createCanvas (chartName: string, newConfig: CanvasConfig) {
  ...
  const createDisplayGroup = (svg: Selection<SVGSVGElement, unknown, HTMLElement, any>) => {
