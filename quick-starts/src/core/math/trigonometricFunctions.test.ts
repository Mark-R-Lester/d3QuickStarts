...
describe('Triangle Calculations', () => {
  describe('hypotenuseFromAdjacent', () => {
    test.each`
      input                                   | expected
      ${{ adjacent: 10, angle: Math.PI / 6 }} | ${11.547}
      ${{ adjacent: 5, angle: Math.PI / 4 }}  | ${7.071}
      ${{ adjacent: 10, angle: 0 }}           | ${10}
  ...
  describe('hypotenuseFromOpposite', () => {
    test.each`
      input                                  | expected
      ${{ opposite: 5, angle: Math.PI / 6 }} | ${10}
      ${{ opposite: 5, angle: Math.PI / 4 }} | ${7.071}
    `('calculates hypotenuse for given input', ({ input, expected }) => {
  ...
  describe('adjacentFromHypotenuse', () => {
    test.each`
      input                                        | expected
      ${{ hypotenuse: 10, angle: Math.PI / 6 }}    | ${8.66}
      ${{ hypotenuse: 7.071, angle: Math.PI / 4 }} | ${5}
      ${{ hypotenuse: 10, angle: 0 }}              | ${10}
  ...
  describe('adjacentFromOpposite', () => {
    test.each`
      input                                  | expected
      ${{ opposite: 5, angle: Math.PI / 6 }} | ${8.66}
      ${{ opposite: 5, angle: Math.PI / 4 }} | ${5}
    `('calculates adjacent for given input', ({ input, expected }) => {
  ...
  describe('oppositeFromHypotenuse', () => {
    test.each`
      input                                        | expected
      ${{ hypotenuse: 10, angle: Math.PI / 6 }}    | ${5}
      ${{ hypotenuse: 7.071, angle: Math.PI / 4 }} | ${5}
      ${{ hypotenuse: 10, angle: 0 }}              | ${0}
  ...
  describe('oppositeFromAdjacent', () => {
    test.each`
      input                                   | expected
      ${{ adjacent: 10, angle: Math.PI / 6 }} | ${5.774}
      ${{ adjacent: 5, angle: Math.PI / 4 }}  | ${5}
      ${{ adjacent: 10, angle: 0 }}           | ${0}
    `('calculates opposite for given input', ({ input, expected }) => {
