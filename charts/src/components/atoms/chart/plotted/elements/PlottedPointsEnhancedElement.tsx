...
export const PlottedPointsEnhancedElement: FunctionComponent<ChartProps> = ({
  ...
  const createChart = () => {
    const data: QsPlottedPointData[] = [
      { x: 15, y: 10, radius: 10, opacity: 0.1 },
      { x: 20, y: 30, radius: 5, opacity: 0.1 },
      { x: 40, y: 26, radius: 30, opacity: 0.1 },
      { x: 90, y: 15, radius: 20, opacity: 0.1 },
      { x: 102, y: 112, radius: 30, opacity: 0.1 },
      { x: 156, y: 140, radius: 15, opacity: 0.1 },
    ]
